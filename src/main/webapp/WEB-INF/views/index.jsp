...
<html lang="en" class="no-js">
    ...
    <!-- let's add tag srping:url -->
		...
		<spring:url value="/WEB-INF/lib/webjars/jquery/2.1.1/" var="webjarJquery" />
		<spring:url value="/WEB-INF/lib/webjars/bootstrap/3.0.0/" var="bootstarp" />
        ...
        <!-- Vendor Styles -->
        <link href="lib/webjars/bootstrap/3.0.0/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
        <link href="resources/theme1/css/animate.css" rel="stylesheet" type="text/css"/>
        <link href="resources/theme1/vendor/themify/themify.css" rel="stylesheet" type="text/css"/>
        <link href="resources/theme1/vendor/scrollbar/scrollbar.min.css" rel="stylesheet" type="text/css"/>
        <link href="resources/theme1/vendor/magnific-popup/magnific-popup.css" rel="stylesheet" type="text/css"/>
        <link href="resources/theme1/vendor/swiper/swiper.min.css" rel="stylesheet" type="text/css"/>
        <link href="resources/theme1/vendor/cubeportfoliof/css/cubeportfolio.min.css" rel="stylesheet" type="text/css"/>

        <!-- Theme Styles -->
        <link href="resources/theme1/css/style.css" rel="stylesheet" type="text/css"/>
        <link href="resources/theme1/css/global/global.css" rel="stylesheet" type="text/css"/>
    ...
    <body>
                        ...
                        <div class="s-header__navbar-row-col">
                            ...
                            <div class="s-header__logo">
                                <a href="index.html" class="s-header__logo-link">
                                    <img class="s-header__logo-img s-header__logo-img-default" src="resources/theme1/img/logo.png" alt="Megakit Logo">
                                    <img class="s-header__logo-img s-header__logo-img-shrink" src="resources/theme1/img/logo-dark.png" alt="Megakit Logo">
                                </a>
                            </div>
                            <!-- End Logo -->
                        </div>
                    ...
                    <div class="row g-margin-b-40--xs">
                        <div class="col-sm-6 g-margin-b-20--xs g-margin-b-0--md">
                            ...
                            <div class="g-margin-b-20--xs">
                                <input type="email" class="form-control s-form-v2__input g-radius--50" placeholder="* Email/Phone">
                                <input type="text" class="form-control s-form-v2__input g-radius--50" placeholder="* Password">
                            </div>
        ...
        <div class="s-swiper js__swiper-one-item">
            ...
            <div class="swiper-wrapper">
                <div class="g-fullheight--xs g-bg-position--center swiper-slide" style="background: url('${images}/1920x1080/02.jpg');">
        ...
        <!-- Testimonials -->
        <div class="js__parallax-window" style="background: url(/resources/img/1920x1080/04.jpg) 50% 0 no-repeat fixed;">
        ...
        <footer class="g-bg-color--dark">
            ...
            <div class="container g-padding-y-50--xs">
                <div class="row">
                    <div class="col-xs-6">
                        <a href="index.html">
                            <img class="g-width-100--xs g-height-auto--xs" src="/resources/img/logo.png" alt="Megakit Logo">
                        </a>
                    </div>
        ...
        <!-- Vendor -->
        <script type="text/javascript" src="/resources/theme1/vendor/jquery.min.js"></script>
        <script type="text/javascript" src="/resources/theme1/vendor/jquery.migrate.min.js"></script>
        <script type="text/javascript" src="/resources/theme1/vendor/bootstrap/js/bootstrap.min.js"></script>
        <script type="text/javascript" src="/resources/theme1/vendor/jquery.smooth-scroll.min.js"></script>
        <script type="text/javascript" src="/resources/theme1/vendor/jquery.back-to-top.min.js"></script>
        <script type="text/javascript" src="/resources/theme1/vendor/scrollbar/jquery.scrollbar.min.js"></script>
        <script type="text/javascript" src="/resources/theme1/vendor/magnific-popup/jquery.magnific-popup.min.js"></script>
        <script type="text/javascript" src="/resources/theme1/vendor/swiper/swiper.jquery.min.js"></script>
        <script type="text/javascript" src="/resources/theme1/vendor/waypoint.min.js"></script>
        <script type="text/javascript" src="/resources/theme1/vendor/counterup.min.js"></script>
        <script type="text/javascript" src="/resources/theme1/vendor/cubeportfolio/js/jquery.cubeportfolio.min.js"></script>
        <script type="text/javascript" src="/resources/theme1/vendor/jquery.parallax.min.js"></script>
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBsXUGTFS09pLVdsYEE9YrO2y4IAncAO2U"></script>
        <script type="text/javascript" src="/resources/theme1/vendor/jquery.wow.min.js"></script>

        <!-- General Components and Settings -->
        <script type="text/javascript" src="/resources/theme1/js/global.min.js"></script>
        <script type="text/javascript" src="/resources/theme1/js/components/header-sticky.min.js"></script>
        <script type="text/javascript" src="/resources/theme1/js/components/scrollbar.min.js"></script>
        <script type="text/javascript" src="/resources/theme1/js/components/magnific-popup.min.js"></script>
        <script type="text/javascript" src="/resources/theme1/js/components/swiper.min.js"></script>
        <script type="text/javascript" src="/resources/theme1/js/components/counter.min.js"></script>
        <script type="text/javascript" src="/resources/theme1/js/components/portfolio-3-col.min.js"></script>
        <script type="text/javascript" src="/resources/theme1/js/components/parallax.min.js"></script>
        <script type="text/javascript" src="/resources/theme1/js/components/google-map.min.js"></script>
        <script type="text/javascript" src="/resources/theme1/js/components/wow.min.js"></script>
        <!--========== END JAVASCRIPTS ==========-->
